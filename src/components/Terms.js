...
// import TermsText from "./TermsText.html";


function Terms() {
  return (
    <Wrapper title="Terms and Conditions">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Rheinland-Pfalz, Germany
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to Izabela Ograbek - art design web by
            mamaminia, Bergstr. 1, 53578 Windhagen.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to mamaminia art. design. web,
            accessible from{" "}
            <a
              href="https://mamaminia.art/"
      ...
      <ul>
        <li>By email: contact@mamaminia.art</li>
      </ul>
    </Wrapper>
  );
}
