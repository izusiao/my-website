    ...
    <Wrapper title="Privacy Policy">
      <Typography color="text.primary">
        ...
        <p>
          ...
          of the Izabela Ograbek - art design web by mamaminia. The use of the
          Internet pages of the Izabela Ograbek - art design web by mamaminia is
        ...
        <p>
          ...
          the Izabela Ograbek - art design web by mamaminia. By means of this
        ...
        <p>
          As the controller, the Izabela Ograbek - art design web by mamaminia
        ...
        <h4>1. Definitions</h4>
        <p>
          The data protection declaration of the Izabela Ograbek - art design
          web by mamaminia is based on the terms used by the European legislator
          for the adoption of the General Data Protection Regulation (GDPR). Our
          data protection declaration should be legible and understandable for
        ...
        <p>Izabela Ograbek - art design web by mamaminia</p>
        <p>Bergstr. 1</p>
        <p>53578 Windhagen</p>
        <p>Germany</p>
        <p>Phone: +4915782785218</p>
        <p>Email: contact@mamaminia.art</p>
        <p>Website: https://mamaminia.art/</p>

        <h4>3. Collection of general data and information</h4>
        <p>
          The website of the Izabela Ograbek - art design web by mamaminia
          ...
          protocol address (IP address), (7) the Internet service provider of
          the accessing system, and (8) any other similar data and information
          that may be used in the event of attacks on our information technology
          systems.
        </p>

        <p>
          When using these general data and information, the Izabela Ograbek -
          art design web by mamaminia does not draw any conclusions about the
          ...
          cyber-attack. Therefore, the Izabela Ograbek - art design web by
          mamaminia analyzes anonymously collected data and information
        ...
        <p>
          The website of the Izabela Ograbek - art design web by mamaminia
          contains information that enables a quick electronic contact to our
        ...
        <ul style={{ listStyle: "none" }}>
          ...
          <li>
            ...
            <p>
              ...
              Izabela Ograbek - art design web by mamaminia, he or she may, at
              any time, contact any employee of the controller. An employee of
              Izabela Ograbek - art design web by mamaminia shall promptly
            ...
            <p>
              ...
              far as processing is not required. An employees of the Izabela
              Ograbek - art design web by mamaminia will arrange the necessary
          ...
          <li>
            ...
            <p>
              ...
              data stored by the Izabela Ograbek - art design web by mamaminia,
              he or she may at any time contact any employee of the controller.
              The employee of the Izabela Ograbek - art design web by mamaminia
          ...
          <li>
            ...
            <p>
              ...
              may at any time contact any employee of the Izabela Ograbek - art
              design web by mamaminia.
            </p>
          </li>
          <li>
            ...
            <p>
              The Izabela Ograbek - art design web by mamaminia shall no longer
            ...
            <p>
              If the Izabela Ograbek - art design web by mamaminia processes
              ...
              direct marketing. If the data subject objects to the Izabela
              Ograbek - art design web by mamaminia to the processing for direct
              marketing purposes, the Izabela Ograbek - art design web by
              mamaminia will no longer process the personal data for these
              purposes.
            </p>
            ...
            <p>
              ...
              personal data concerning him or her by the Izabela Ograbek - art
              design web by mamaminia for scientific or historical research
            ...
            <p>
              ...
              contact any employee of the Izabela Ograbek - art design web by
              mamaminia. In addition, the data subject is free in the context of
          ...
          <li>
            ...
            <p>
              ...
              consent, the Izabela Ograbek - art design web by mamaminia shall
          ...
          <li>
            ...
            <p>
              ...
              Izabela Ograbek - art design web by mamaminia.
            </p>
          </li>
        </ul>
        <h4>
        ...
        <p>
          ...
          application documents by e-mail or by means of a web form on the
          website to the controller. If the data controller concludes an
          employment contract with an applicant, the submitted data will be
          stored for the purpose of processing the employment relationship in
          ...
          documents shall be automatically erased two months after notification
          of the refusal decision, provided that no other legitimate interests
          of the controller are opposed to the erasure. Other legitimate
          interest in this relation is, e.g. a burden of proof in a procedure
